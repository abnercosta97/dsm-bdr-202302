...
CREATE OR REPLACE FUNCTION fc_atualizar()
RETURNS TRIGGER
language plpgsql AS
$$
BEGIN

update tbl_departamentos set qtde_projetos = qtde_projetos - 1 where cod_departamento = OLD.cod_departamento;
RETURN OLD;
END
$$ ;
CREATE OR REPLACE TRIGGER tr_atualizar_projeto
